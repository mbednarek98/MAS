...
public class Client implements Serializable { // Klient
    ...
    private static Set<Order> allOrders = new HashSet<>();
    // -----------------
    ...
    // -- Metody klasy --
    /**
     * dodajZamowienie()              -- Metoda kompozycji --
     *
     */
    public void addOrder(Order order) throws Exception {
        if(!orders.contains(order)) {
            if(allOrders.contains(order)) throw new Exception("Takie zamowienie jest juz przypisane do klienta!");
            orders.add(order);
            allOrders.add(order);
        }
    }
    /**
     * usunKlienta()              -- Metoda kompozycji --
     *
     */
    ...
    public String toString() {
        ...
        for(Order order : orders) {
            info += "\t ===== Klasa Zamowienie =====\n"+
                    "\t-> Data zamowienia:\t" + order.getDateofOrder() +",\n"+
                    "\t-> Data oddania:\t" + order.getDateofDelivery() +",\n"+
                    "\t-> Typ platnosci:\t" + order.getTypeofPayment() + ",\n"+
